...
class ExtRandomHorizontalFlip(object):
    ...
    def __call__(self, img, lbl):
        ...
        if random.random() < self.p:
            return TF.hflip(img), TF.hflip(lbl)
        return img, lbl
...
class ExtRandomScale(object):
    ...
    def __call__(self, img, lbl):
        ...
        return TF.resize(img, target_size, self.interpolation), TF.resize(lbl, target_size, Image.NEAREST)
...
class ExtRandomCrop(object):
    ...
    def __call__(self, img, lbl):
        ...
        return TF.crop(img, i, j, h, w), TF.crop(lbl, i, j, h, w)
...
class ExtResize(object):
    ...
    def __call__(self, img, lbl):
        ...
        Returns:
            PIL Image: Rescaled image.
        """
        return TF.resize(img, self.size, self.interpolation), TF.resize(lbl, self.size, Image.NEAREST)
